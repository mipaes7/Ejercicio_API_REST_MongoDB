...
router.post('/', providerController.createProviderController);
router.put('/', providerController.updateProviderController);
router.delete('/', providerController.deleteProviderController);
